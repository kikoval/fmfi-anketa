...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $a->setSQLLogger(new \Symfony\Bundle\DoctrineBundle\Logger\DbalLogger(NULL));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('host' => 'localhost', 'driver' => 'pdo_sqlite', 'driverOptions' => array(), 'user' => 'root', 'password' => '', 'port' => NULL, 'dbname' => 'anketa', 'path' => '/Users/ivan/Sites/Symfony2/app/anketa.db', 'memory' => true, 'charset' => 'UTF8'), $a, new \Doctrine\Common\EventManager());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d->setProxyDir('/Users/ivan/Sites/Symfony2/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['router.cached'] = new \Symfony\Bundle\FrameworkBundle\Routing\CachedRouter('/Users/ivan/Sites/Symfony2/app/cache/dev', 'appdevUrlMatcher', 'appdevUrlGenerator');
    }
    ...
    {
        return $this->services['router.real'] = new \Symfony\Component\Routing\Router(new \Symfony\Bundle\FrameworkBundle\Routing\LazyLoader($this, 'routing.loader.real'), '/Users/ivan/Sites/Symfony2/app/config/routing.yml', array('cache_dir' => '/Users/ivan/Sites/Symfony2/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appdevUrlGenerator', 'matcher_class' => 'Symfony\\Component\\Routing\\Matcher\\UrlMatcher', 'matcher_base_class' => 'Symfony\\Component\\Routing\\Matcher\\UrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appdevUrlMatcher', 'resource_type' => ''));
    }
    ...
    {
        $this->services['translator.real'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('cache_dir' => '/Users/ivan/Sites/Symfony2/app/cache/dev/translations', 'debug' => true), $this->get('session'));
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'cache' => '/Users/ivan/Sites/Symfony2/app/cache/dev/twig', 'charset' => 'UTF-8'));
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\StaticExtension($this->get('assetic.asset_factory'), true, 'js/*.js', 'css/*.css'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), '/Users/ivan/Sites/Symfony2/app/../web', true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Users/ivan/Sites/Symfony2/app/cache/dev',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Users/ivan/Sites/Symfony2/app/cache/dev/twig',
                'charset' => 'UTF-8',
            ),
            ...
            'doctrine.orm.proxy_dir' => '/Users/ivan/Sites/Symfony2/app/cache/dev/doctrine/orm/Proxies',
            ...
            'assetic.cache_dir' => '/Users/ivan/Sites/Symfony2/app/cache/dev/assetic',
